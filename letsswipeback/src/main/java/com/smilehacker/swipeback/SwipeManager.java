...
public class SwipeManager {
    ...
    public void setSwipeEnable(Activity activity, boolean enable) {
        SwipePage page = getPage(activity);
        if (page != null) {
            page.setSwipeEnable(enable);
        }
    }

    public void setEnableResetTranslucent(Activity activity, boolean enable) {
        SwipePage page = getPage(activity);
        if (page != null) {
            page.setEnableResetTranslucent(enable);
        }
    }
}
